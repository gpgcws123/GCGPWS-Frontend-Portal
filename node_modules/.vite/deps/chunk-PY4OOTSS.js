...
function usePresence(subscribe = true) {
  ...
  const id3 = (0, import_react4.useId)();
  (0, import_react4.useEffect)(() => {
    if (subscribe)
      register(id3);
  }, [subscribe]);
  const safeToRemove = (0, import_react4.useCallback)(() => subscribe && onExitComplete && onExitComplete(id3), [id3, onExitComplete, subscribe]);
...
function useVisualElement(Component2, visualState, props, createVisualElement, ProjectionNodeConstructor) {
  ...
  const visualElementRef = (0, import_react11.useRef)(null);
  ...
  const wantsHandoff = (0, import_react11.useRef)(Boolean(optimisedAppearId) && !((_a = window.MotionHandoffIsComplete) === null || _a === void 0 ? void 0 : _a.call(window, optimisedAppearId)) && ((_b = window.MotionHasOptimisedAnimation) === null || _b === void 0 ? void 0 : _b.call(window, optimisedAppearId)));
...
function createRendererMotionComponent({ preloadedFeatures, createVisualElement, useRender, useVisualState, Component: Component2 }) {
  ...
  const ForwardRefMotionComponent = (0, import_react12.forwardRef)(MotionComponent);
...
var makeUseVisualState = (config) => (props, isStatic) => {
  const context = (0, import_react14.useContext)(MotionContext);
...
// node_modules/framer-motion/dist/es/motion/features/layout/MeasureLayout.mjs
var MeasureLayoutWithContext = class extends import_react15.Component {
  /**
...
function MeasureLayout(props) {
  ...
  const layoutGroup = (0, import_react15.useContext)(LayoutGroupContext);
  return (0, import_jsx_runtime2.jsx)(MeasureLayoutWithContext, { ...props, layoutGroup, switchLayoutGroup: (0, import_react15.useContext)(SwitchLayoutGroupContext), isPresent: isPresent2, safeToRemove });
}
...
//# sourceMappingURL=chunk-PY4OOTSS.js.map
