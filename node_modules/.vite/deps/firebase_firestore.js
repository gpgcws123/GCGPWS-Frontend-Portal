...
var je = "globals";
var He = "name";
var Je = [...[...[...[...[Y, X, ie, j, Pe, H, me, Ee], pe], le], fe], we, be];
var Ye = [...Je, $e];
var Ze = [Y, X, ie, se, Pe, H, me, Ee, pe, le, fe, we, be, $e];
var Xe = Ze;
var et = [...Xe, ve, xe, Le];
var tt = et;
var nt = [...et, je];
...
var __PRIVATE_TargetIndexMatcher = class {
  ...
  wn(e) {
    ...
    if (this.fn.size > 0) {
      ...
      if (!r.has(e2.field.canonicalString())) {
        const t2 = n[i];
        if (!this.bn(e2, t2) || !this.Dn(this.gn[s++], t2)) return false;
      }
      ++i;
    }
    for (; i < n.length; ++i) {
  ...
  Sn(e) {
    for (const t of this.pn) if (this.bn(t, e)) return true;
    return false;
  }
  bn(e, t) {
...
var __PRIVATE_SchemaConverter = class {
  ...
  q(e, t, n, r) {
    ...
    }(e), this.Si(i)))), n < 7 && r >= 7 && (s = s.next(() => this.bi(i))), n < 8 && r >= 8 && (s = s.next(() => this.Di(e, i))), n < 9 && r >= 9 && (s = s.next(() => {
  ...
  Mi(e, t) {
    ...
    return n.J().next((e2) => {
      ...
      return e2.forEach((e3) => {
        ...
        const s = new User(n3), o = __PRIVATE_IndexedDbDocumentOverlayCache.St(this.serializer, s), _ = i.getIndexManager(s), a = __PRIVATE_IndexedDbMutationQueue.St(s, this.serializer, _, i.referenceDelegate);
...
var __PRIVATE_WebChannelConnection = class extends __PRIVATE_RestConnection {
  ...
  T_(e, t, n) {
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      h || (h = true, __PRIVATE_logDebug(Yt, `RPC '${e}' stream ${r} transport closed`), P.u_());
...
var __PRIVATE_ExponentialBackoff = class {
  constructor(e, t, n = 1e3, r = 1.5, i = 6e4) {
    this.xi = e, this.timerId = t, this.I_ = n, this.E_ = r, this.d_ = i, this.A_ = 0, this.R_ = null, /** The last backoff attempt, as epoch milliseconds. */
  ...
  f_(e) {
    ...
    r > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${r} ms (base delay: ${this.A_} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`), this.R_ = this.xi.enqueueAfterDelay(this.timerId, r, () => (this.V_ = Date.now(), e())), // Apply backoff factor to determine next delay and ensure it is within
    // bounds.
...
var __PRIVATE_PersistentStream = class {
  constructor(e, t, n, r, i, s, o, _) {
    this.xi = e, this.y_ = n, this.w_ = r, this.connection = i, this.authCredentialsProvider = s, this.appCheckCredentialsProvider = o, this.listener = _, this.state = 0, /**
   ...
   */
  async close(e, t) {
    this.k_(), this.q_(), this.C_.cancel(), // Invalidates any stream-related callbacks (e.g. from auth or the
    ...
    this.S_++, 4 !== e ? (
      ...
      (__PRIVATE_logError(t.toString()), __PRIVATE_logError("Using maximum backoff delay to prevent overloading the backend."), this.C_.m_())
    ...
    null !== this.stream && (this.Q_(), this.stream.close(), this.stream = null), // This state must be assigned before calling onClose() to allow the callback to
  ...
  auth() {
    ...
    Promise.all([this.authCredentialsProvider.getToken(), this.appCheckCredentialsProvider.getToken()]).then(([e2, n]) => {
      this.S_ === t && // Normally we'd have to schedule the callback on the AsyncQueue.
  ...
  K_(e, t) {
    ...
    this.stream = this.G_(e, t), this.stream.e_(() => {
      ...
      n(() => (this.state = 2, this.D_ = this.xi.enqueueAfterDelay(this.w_, 1e4, () => (this.M_() && (this.state = 3), Promise.resolve())), this.listener.n_()));
    }), this.stream.i_((e2) => {
      n(() => this.W_(e2));
    }), this.stream.onMessage((e2) => {
      n(() => 1 == ++this.v_ ? this.z_(e2) : this.onNext(e2));
    });
  }
  x_() {
  ...
  U_(e) {
    return (t) => {
      this.xi.enqueueAndForget(() => this.S_ === e ? t() : (__PRIVATE_logDebug(Zt, "stream callback skipped by getCloseGuardedDispatcher."), Promise.resolve()));
    };
  }
};
var __PRIVATE_PersistentListenStream = class extends __PRIVATE_PersistentStream {
  ...
  J_(e) {
    const t = {};
    t.database = __PRIVATE_getEncodedDatabaseId(this.serializer), t.removeTarget = e, this.L_(t);
  }
};
...
var __PRIVATE_DatastoreImpl = class extends Datastore {
  constructor(e, t, n, r) {
    super(), this.authCredentials = e, this.appCheckCredentials = t, this.connection = n, this.serializer = r, this.na = false;
  }
  ra() {
  ...
  zo(e, t, n, r) {
    return this.ra(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([i, s]) => this.connection.zo(e, __PRIVATE_toResourcePath(t, n), r, i, s)).catch((e2) => {
  ...
  Yo(e, t, n, r, i) {
    return this.ra(), Promise.all([this.authCredentials.getToken(), this.appCheckCredentials.getToken()]).then(([s, o]) => this.connection.Yo(e, __PRIVATE_toResourcePath(t, n), r, s, o, i)).catch((e2) => {
      throw "FirebaseError" === e2.name ? (e2.code === N.UNAUTHENTICATED && (this.authCredentials.invalidateToken(), this.appCheckCredentials.invalidateToken()), e2) : new FirestoreError(N.UNKNOWN, e2.toString());
    });
  }
  terminate() {
...
var __PRIVATE_OnlineStateTracker = class {
  ...
  _a() {
    0 === this.ia && (this.aa(
      "Unknown"
      /* OnlineState.Unknown */
    ), this.sa = this.asyncQueue.enqueueAfterDelay("online_state_timeout", 1e4, () => (this.sa = null, this.ua("Backend didn't respond within 10 seconds."), this.aa(
      "Offline"
      /* OnlineState.Offline */
    ), Promise.resolve())));
  }
   ...
   */
  ca(e) {
    "Online" === this.state ? this.aa(
      "Unknown"
      /* OnlineState.Unknown */
    ) : (this.ia++, this.ia >= 1 && (this.la(), this.ua(`Connection failed 1 times. Most recent error: ${e.toString()}`), this.aa(
      "Offline"
      /* OnlineState.Offline */
    )));
  }
   ...
   */
  set(e) {
    this.la(), this.ia = 0, "Online" === e && // We've connected to watch at least once. Don't warn the developer
    // about being offline going forward.
    (this.oa = false), this.aa(e);
  }
  aa(e) {
...
This typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend.`;
    this.oa ? (__PRIVATE_logError(t), this.oa = false) : __PRIVATE_logDebug("OnlineStateTracker", t);
  }
  la() {
...
var __PRIVATE_RemoteStoreImpl = class {
  constructor(e, t, n, r, i) {
     ...
     */
    this.Ia = [], this.Ea = i, this.Ea.No((e2) => {
      n.enqueueAndForget(async () => {
        __PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug(Xt, "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e3) {
          ...
          ), await __PRIVATE_disableNetworkInternal(t2), t2.da.set(
            "Unknown"
            /* OnlineState.Unknown */
          ), t2.Ta.delete(
            4
...
async function __PRIVATE_enableNetworkInternal(e) {
  if (__PRIVATE_canUseNetwork(e)) for (const t of e.Ia) await t(
    /* enabled= */
    true
  );
}
async function __PRIVATE_disableNetworkInternal(e) {
  for (const t of e.Ia) await t(
    /* enabled= */
    false
  );
}
function __PRIVATE_remoteStoreListen(e, t) {
  const n = __PRIVATE_debugCast(e);
  n.Pa.has(t.targetId) || // Mark this as something the client is currently listening for.
  (n.Pa.set(t.targetId, t), __PRIVATE_shouldStartWatchStream(n) ? (
    // The listen will be sent in onWatchStreamOpen
    __PRIVATE_startWatchStream(n)
  ) : __PRIVATE_ensureWatchStream(n).M_() && __PRIVATE_sendWatchRequest(n, t));
}
function __PRIVATE_remoteStoreUnlisten(e, t) {
  const n = __PRIVATE_debugCast(e), r = __PRIVATE_ensureWatchStream(n);
  n.Pa.delete(t), r.M_() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.Pa.size && (r.M_() ? r.N_() : __PRIVATE_canUseNetwork(n) && // Revert to OnlineState.Unknown if the watch stream is not open and we
  ...
  if (
    ...
    try {
      await async function __PRIVATE_handleTargetError(e2, t2) {
        ...
        for (const r of t2.targetIds)
          e2.Pa.has(r) && (await e2.remoteSyncer.rejectListen(r, n2), e2.Pa.delete(r), e2.Aa.removeTarget(r));
      }(e, t);
    } catch (n2) {
      __PRIVATE_logDebug(Xt, "Failed to remove targets %s: %s ", t.targetIds.join(","), n2), await __PRIVATE_disableNetworkUntilRecovery(e, n2);
    }
  else if (t instanceof __PRIVATE_DocumentWatchChange ? e.Aa.Xe(t) : t instanceof __PRIVATE_ExistenceFilterChange ? e.Aa.ot(t) : e.Aa.nt(t), !n.isEqual(SnapshotVersion.min())) try {
    ...
    */
    await function __PRIVATE_raiseWatchSnapshot(e2, t3) {
      const n2 = e2.Aa.It(t3);
      return n2.targetChanges.forEach((n3, r) => {
        if (n3.resumeToken.approximateByteSize() > 0) {
          const i = e2.Pa.get(r);
          i && e2.Pa.set(r, i.withResumeToken(n3.resumeToken, t3));
        }
      }), // Re-establish listens for the targets that have been invalidated by
      // existence filter mismatches.
      n2.targetMismatches.forEach((t4, n3) => {
        const r = e2.Pa.get(t4);
        if (!r)
          return;
        e2.Pa.set(t4, r.withResumeToken(ByteString.EMPTY_BYTE_STRING, r.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
...
async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  ...
  await __PRIVATE_disableNetworkInternal(e), e.da.set(
    "Offline"
    /* OnlineState.Offline */
  ...
  e.asyncQueue.enqueueRetryable(async () => {
    __PRIVATE_logDebug(Xt, "Retrying IndexedDB access"), await n(), e.Ta.delete(
      1
      /* OfflineCause.IndexedDbFailed */
...
async function __PRIVATE_onWriteStreamClose(e, t) {
  ...
  await async function __PRIVATE_handleWriteError(e2, t2) {
    if (function __PRIVATE_isPermanentWriteError(e3) {
      ...
      const n = e2.ha.shift();
      __PRIVATE_ensureWriteStream(e2).O_(), await __PRIVATE_executeWithRecovery(e2, () => e2.remoteSyncer.rejectFailedWrite(n.batchId, t2)), // It's possible that with the completion of this mutation
...
async function __PRIVATE_remoteStoreHandleCredentialChange(e, t) {
  ...
  n.da.set(
    "Unknown"
    /* OnlineState.Unknown */
  ), await n.remoteSyncer.handleCredentialChange(t), n.Ta.delete(
    3
    /* OfflineCause.CredentialChange */
...
async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  ...
  ), await __PRIVATE_enableNetworkInternal(n)) : t || (n.Ta.add(
    2
    /* OfflineCause.IsSecondary */
  ), await __PRIVATE_disableNetworkInternal(n), n.da.set(
    "Unknown"
    /* OnlineState.Unknown */
  ));
}
function __PRIVATE_ensureWatchStream(e) {
  return e.Ra || // Create stream (but note that it is not started yet).
  (e.Ra = function __PRIVATE_newPersistentWatchStream(e2, t, n) {
    ...
    t ? (e.Ra.O_(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.da.set(
      "Unknown"
      /* OnlineState.Unknown */
    )) : (await e.Ra.stop(), __PRIVATE_cleanUpWatchStreamState(e));
  })), e.Ra;
}
function __PRIVATE_ensureWriteStream(e) {
  return e.Va || // Create stream (but note that it is not started yet).
  (e.Va = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    const r = __PRIVATE_debugCast(e2);
    ...
    t ? (e.Va.O_(), // This will start the write stream if necessary.
    await __PRIVATE_fillWritePipeline(e)) : (await e.Va.stop(), e.ha.length > 0 && (__PRIVATE_logDebug(Xt, `Stopping write stream with ${e.ha.length} pending writes`), e.ha = []));
  })), e.Va;
}
...
var __PRIVATE_DocumentChangeSet = class {
  ...
  track(e) {
    ...
    n ? (
      ...
      0 !== e.type && 3 === n.type ? this.ma = this.ma.insert(t, e) : 3 === e.type && 1 !== n.type ? this.ma = this.ma.insert(t, {
        type: n.type,
        doc: e.doc
      }) : 2 === e.type && 2 === n.type ? this.ma = this.ma.insert(t, {
        type: 2,
        doc: e.doc
      }) : 2 === e.type && 0 === n.type ? this.ma = this.ma.insert(t, {
        type: 0,
        doc: e.doc
      }) : 1 === e.type && 0 === n.type ? this.ma = this.ma.remove(t) : 1 === e.type && 2 === n.type ? this.ma = this.ma.insert(t, {
        type: 1,
        doc: n.doc
      }) : 0 === e.type && 1 === n.type ? this.ma = this.ma.insert(t, {
        type: 2,
        doc: e.doc
      }) : (
  ...
  terminate() {
    !function __PRIVATE_errorAllTargets(e, t) {
      ...
      n.queries = __PRIVATE_newQueriesObjectMap(), r.forEach((e2, n2) => {
        for (const e3 of n2.ya) e3.onError(t);
      });
...
async function __PRIVATE_eventManagerListen(e, t) {
  ...
  s ? !s.wa() && t.Sa() && // Query has been listening to local cache, and tries to add a new listener sourced from watch.
  (r = 2) : (s = new __PRIVATE_QueryListenersInfo(), r = t.Sa() ? 0 : 1);
  try {
    switch (r) {
      case 0:
        s.pa = await n.onListen(
          i,
          /** enableRemoteListen= */
          true
        );
  ...
  if (n.queries.set(i, s), s.ya.push(t), // Run global snapshot listeners if a consistent snapshot has been emitted.
...
async function __PRIVATE_eventManagerUnlisten(e, t) {
  ...
  if (s) {
    const e2 = s.ya.indexOf(t);
    e2 >= 0 && (s.ya.splice(e2, 1), 0 === s.ya.length ? i = t.Sa() ? 0 : 1 : !s.wa() && t.Sa() && // The removed listener is the last one that sourced from watch.
    (i = 2));
  }
  switch (i) {
    case 0:
...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
  ...
  for (const e2 of t) {
    ...
    if (i) {
      for (const t3 of i.ya) t3.va(e2) && (r = true);
      i.pa = e2;
    }
  }
...
function __PRIVATE_eventManagerOnWatchError(e, t, n) {
  ...
  if (i) for (const e2 of i.ya) e2.onError(n);
  r.queries.delete(t);
}
...
var en;
var tn;
(tn = en || (en = {})).Ca = "default", /** Listen to changes in cache only */
tn.Cache = "cache";
var __PRIVATE_QueryListener = class {
  constructor(e, t, n) {
     ...
     */
    this.Ma = false, this.xa = null, this.onlineState = "Unknown", this.options = n || {};
  }
  /**
  ...
  va(e) {
    ...
    let t = false;
    return this.Ma ? this.Oa(e) && (this.Fa.next(e), t = true) : this.Na(e, this.onlineState) && (this.Ba(e), t = true), this.xa = e, t;
  }
  onError(e) {
    this.Fa.error(e);
  }
  ...
  Da(e) {
    this.onlineState = e;
    let t = false;
    return this.xa && !this.Ma && this.Na(this.xa, e) && (this.Ba(this.xa), t = true), t;
  }
  Na(e, t) {
    if (!e.fromCache) return true;
    if (!this.Sa()) return true;
    const n = "Offline" !== t;
    return (!this.options.La || !n) && (!e.docs.isEmpty() || e.hasCachedResults || "Offline" === t);
  }
  Oa(e) {
  ...
  Ba(e) {
    e = ViewSnapshot.fromInitialDocuments(e.query, e.docs, e.mutatedKeys, e.fromCache, e.hasCachedResults), this.Ma = true, this.Fa.next(e);
  }
  Sa() {
...
var __PRIVATE_BundleLoader = class {
  constructor(e, t, n) {
    this.Qa = e, this.localStore = t, this.serializer = n, /** Batched queries to be saved into storage */
  ...
  $a(e) {
    ...
    if (e.ka.namedQuery) this.queries.push(e.ka.namedQuery);
    ...
    } else e.ka.document && (this.documents[this.documents.length - 1].document = e.ka.document, ++t);
...
var __PRIVATE_View = class {
  constructor(e, t) {
    this.query = e, this.Ga = t, this.za = null, this.hasCachedResults = false, /**
    ...
    this.ja = __PRIVATE_documentKeySet(), /** Document Keys that have local changes */
    this.mutatedKeys = __PRIVATE_documentKeySet(), this.Ha = __PRIVATE_newQueryComparator(e), this.Ja = new DocumentSet(this.Ha);
  }
  /**
    ...
    if (e.inorderTraversal((e2, t2) => {
      ...
      if (u && c) {
        u.data.isEqual(c.data) ? l !== h && (n.track({
          type: 3,
          doc: c
        }), P = true) : this.eu(u, c) || (n.track({
          type: 2,
          doc: c
        }), P = true, (_ && this.Ha(c, _) > 0 || a && this.Ha(c, a) < 0) && // This doc moved from inside the limit to outside the limit.
  ...
  applyChanges(e, t, n, r) {
    ...
    }(e2.type, t2.type) || this.Ha(e2.doc, t2.doc)), this.tu(n), r = null != r && r;
    const o = t && !r ? this.nu() : [], _ = 0 === this.ja.size && this.current && !r ? 1 : 0, a = _ !== this.za;
   ...
   */
  iu(e) {
    return !this.Ga.has(e) && // The local store doesn't think it's a result, so it shouldn't be in limbo.
   ...
   */
  tu(e) {
    e && (e.addedDocuments.forEach((e2) => this.Ga = this.Ga.add(e2)), e.modifiedDocuments.forEach((e2) => {
    }), e.removedDocuments.forEach((e2) => this.Ga = this.Ga.delete(e2)), this.current = e.current);
  }
  nu() {
    if (!this.current) return [];
    const e = this.ja;
    this.ja = __PRIVATE_documentKeySet(), this.Ja.forEach((e2) => {
      this.iu(e2.key) && (this.ja = this.ja.add(e2.key));
    });
    const t = [];
    return e.forEach((e2) => {
      this.ja.has(e2) || t.push(new __PRIVATE_RemovedLimboDocument(e2));
    }), this.ja.forEach((n) => {
...
var __PRIVATE_SyncEngineImpl = class {
  constructor(e, t, n, r, i, s) {
    this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.au = {}, this.uu = new ObjectMap((e2) => __PRIVATE_canonifyQuery(e2), __PRIVATE_queryEquals), this.cu = /* @__PURE__ */ new Map(), /**
     ...
     */
    this.Pu = /* @__PURE__ */ new Map(), this.Tu = new __PRIVATE_ReferenceSet(), /** Stores user completion handlers, indexed by User and BatchId. */
    this.Iu = {}, /** Stores user callbacks waiting for all pending writes to be acknowledged. */
    this.Eu = /* @__PURE__ */ new Map(), this.du = __PRIVATE_TargetIdGenerator.lr(), this.onlineState = "Unknown", // The primary state is set to `true` or `false` immediately after Firestore
...
async function __PRIVATE_syncEngineListen(e, t, n = true) {
  ...
  return s ? (
    ...
    (r.sharedClientState.addLocalQueryTarget(s.targetId), i = s.view.ou())
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, r, i) {
  e.Ru = (t2, n2, r2) => async function __PRIVATE_applyDocChanges(e2, t3, n3, r3) {
    let i2 = t3.view.Za(n3);
    ...
    (i2 = await __PRIVATE_localStoreExecuteQuery(
      ...
      /* usePreviousResults= */
      false
    ).then(({ documents: e3 }) => t3.view.Za(e3, i2)));
    ...
    return __PRIVATE_updateTrackedLimbos(e2, t3.targetId, _2.ru), _2.snapshot;
  }(e, t2, n2, r2);
  const s = await __PRIVATE_localStoreExecuteQuery(
    ...
    /* usePreviousResults= */
    true
  ), o = new __PRIVATE_View(t, s.$s), _ = o.Za(s.documents), a = TargetChange.createSynthesizedTargetChangeForCurrentChange(n, r && "Offline" !== e.onlineState, i), u = o.applyChanges(
    _,
    /* limboResolutionEnabled= */
    e.isPrimaryClient,
    a
...
async function __PRIVATE_syncEngineUnlisten(e, t, n) {
  ...
  if (s.length > 1) return r.cu.set(i.targetId, s.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void r.uu.delete(t);
...
async function __PRIVATE_syncEngineWrite(e, t, n) {
  ...
  try {
    ...
    r.sharedClientState.addPendingMutation(e2.batchId), function __PRIVATE_addMutationCallback(e3, t2, n2) {
      let r2 = e3.Iu[e3.currentUser.toKey()];
      r2 || (r2 = new SortedMap(__PRIVATE_primitiveComparator));
      r2 = r2.insert(t2, n2), e3.Iu[e3.currentUser.toKey()] = r2;
...
async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
  ...
  try {
    ...
    t.targetChanges.forEach((e3, t2) => {
      ...
      (__PRIVATE_hardAssert(e3.addedDocuments.size + e3.modifiedDocuments.size + e3.removedDocuments.size <= 1, 22616), e3.addedDocuments.size > 0 ? r._u = true : e3.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r._u, 14607) : e3.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r._u, 42227), r._u = false));
  ...
  if (r.isPrimaryClient && 0 === n || !r.isPrimaryClient && 1 === n) {
    ...
    r.uu.forEach((n2, r2) => {
      ...
      n2.queries.forEach((e4, n3) => {
        for (const e5 of n3.ya)
          e5.Da(t2) && (r2 = true);
      }), r2 && __PRIVATE_raiseSnapshotsInSyncEvent(n2);
    }(r.eventManager, t), e2.length && r.au.j_(e2), r.onlineState = t, r.isPrimaryClient && r.sharedClientState.setOnlineState(t);
  }
}
...
function __PRIVATE_processUserCallback(e, t, n) {
  ...
  if (i) {
    const e2 = i.get(t);
    e2 && (n ? e2.reject(n) : e2.resolve(), i = i.remove(t)), r.Iu[r.currentUser.toKey()] = i;
  }
}
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  if (e.cu.delete(t), e.isPrimaryClient) {
    e.Tu.Hr(t).forEach((t2) => {
      e.Tu.containsKey(t2) || // We removed the last reference for this key
...
function __PRIVATE_removeLimboTarget(e, t) {
  ...
  const n = e.hu.get(t);
  null !== n && (__PRIVATE_remoteStoreUnlisten(e.remoteStore, n), e.hu = e.hu.remove(t), e.Pu.delete(n), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r of n) if (r instanceof __PRIVATE_AddedLimboDocument) e.Tu.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
    ...
    e.Tu.containsKey(r.key) || // We removed the last reference for this key
...
function __PRIVATE_trackLimboChange(e, t) {
  ...
  e.hu.get(n) || e.lu.has(r) || (__PRIVATE_logDebug(nn, "New document in limbo: " + n), e.lu.add(r), __PRIVATE_pumpEnqueuedLimboResolutions(e));
}
function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
  for (; e.lu.size > 0 && e.hu.size < e.maxConcurrentLimboResolutions; ) {
    ...
    e.Pu.set(r, new LimboResolution(n)), e.hu = e.hu.insert(n, r), __PRIVATE_remoteStoreListen(e.remoteStore, new TargetData(__PRIVATE_queryToTarget(__PRIVATE_newQueryForPath(n.path)), r, "TargetPurposeLimboResolution", __PRIVATE_ListenSequence.le));
  }
}
async function __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(e, t, n) {
  const r = __PRIVATE_debugCast(e), i = [], s = [], o = [];
  r.uu.isEmpty() || (r.uu.forEach((e2, _) => {
    o.push(r.Ru(_, t, n).then((e3) => {
      var t2;
  ...
  }), await Promise.all(o), r.au.j_(i), await async function __PRIVATE_localStoreNotifyLocalViewChanges(e2, t2) {
...
function __PRIVATE_syncEngineGetRemoteKeysForTarget(e, t) {
  ...
  if (r && r._u) return __PRIVATE_documentKeySet().add(r.key);
  {
    ...
    if (!r2) return e2;
    for (const t2 of r2) {
      const r3 = n.uu.get(t2);
      e2 = e2.unionWith(r3.view.Ya);
    }
    return e2;
  }
}
async function __PRIVATE_synchronizeViewAndComputeSnapshot(e, t) {
  ...
  return n.isPrimaryClient && __PRIVATE_updateTrackedLimbos(n, t.targetId, i.ru), i;
}
...
async function __PRIVATE_syncEngineApplyPrimaryState(e, t) {
  const n = __PRIVATE_debugCast(e);
  if (__PRIVATE_ensureWatchCallbacks(n), __PRIVATE_syncEngineEnsureWriteCallbacks(n), true === t && true !== n.Au) {
    ...
    n.Au = true, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, true);
    for (const e3 of t2) __PRIVATE_remoteStoreListen(n.remoteStore, e3);
  } else if (false === t && false !== n.Au) {
    const e2 = [];
    ...
    function __PRIVATE_resetLimboDocuments(e3) {
      ...
      }), t3.Tu.Jr(), t3.Pu = /* @__PURE__ */ new Map(), t3.hu = new SortedMap(DocumentKey.comparator);
    }(n), n.Au = false, await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, false);
  }
}
async function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
  ...
  for (const e2 of t) {
    let t2;
    const n2 = r.cu.get(e2);
    if (n2 && 0 !== n2.length) {
      t2 = await __PRIVATE_localStoreAllocateTarget(r.localStore, __PRIVATE_queryToTarget(n2[0]));
      for (const e3 of n2) {
        const t3 = r.uu.get(e3), n3 = await __PRIVATE_synchronizeViewAndComputeSnapshot(r, t3);
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r.Au) {
    for (const e2 of t) {
      if (r.cu.has(e2) && r.sharedClientState.isActiveQueryTarget(e2)) {
    ...
    for (const e2 of n)
      r.cu.has(e2) && // Release queries that are still active.
      await __PRIVATE_localStoreReleaseTarget(
        r.localStore,
        e2,
        /* keepPersistedTargetData */
...
function __PRIVATE_ensureWatchCallbacks(e) {
  const t = __PRIVATE_debugCast(e);
  return t.remoteStore.remoteSyncer.applyRemoteEvent = __PRIVATE_syncEngineApplyRemoteEvent.bind(null, t), t.remoteStore.remoteSyncer.getRemoteKeysForTarget = __PRIVATE_syncEngineGetRemoteKeysForTarget.bind(null, t), t.remoteStore.remoteSyncer.rejectListen = __PRIVATE_syncEngineRejectListen.bind(null, t), t.au.j_ = __PRIVATE_eventManagerOnWatchChange.bind(null, t.eventManager), t.au.Vu = __PRIVATE_eventManagerOnWatchError.bind(null, t.eventManager), t;
}
...
function __PRIVATE_syncEngineLoadBundle(e, t, n) {
  ...
  (async function __PRIVATE_loadBundleImpl(e2, t2, n2) {
    try {
      ...
      let s = await t2.gu();
      for (; s; ) {
        const e3 = await i.$a(s);
        e3 && n2._updateProgress(e3), s = await t2.gu();
      }
      ...
      }(e2.localStore, r2), n2._completeWith(o.progress), Promise.resolve(o.Ka);
    } catch (e3) {
...
var __PRIVATE_MemoryOfflineComponentProvider = class {
  ...
  async initialize(e) {
    this.serializer = __PRIVATE_newSerializer(e.databaseInfo.databaseId), this.sharedClientState = this.pu(e), this.persistence = this.yu(e), await this.persistence.start(), this.localStore = this.wu(e), this.gcScheduler = this.Su(e, this.localStore), this.indexBackfillerScheduler = this.bu(e, this.localStore);
  }
  Su(e, t) {
    return null;
  }
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends __PRIVATE_MemoryOfflineComponentProvider {
  constructor(e, t, n) {
    super(), this.Du = e, this.cacheSizeBytes = t, this.forceOwnership = n, this.kind = "persistent", this.synchronizeTabs = false;
  }
  async initialize(e) {
    await super.initialize(e), await this.Du.initialize(this, e), // Enqueue writes from a previous session
    await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Du.syncEngine), await __PRIVATE_fillWritePipeline(this.Du.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(
      ...
      /* forceOwnership= */
      false
    ), this.Du = e, this.cacheSizeBytes = t, this.synchronizeTabs = true;
  }
  async initialize(e) {
    ...
    await this.persistence.Ji(async (e2) => {
      await __PRIVATE_syncEngineApplyPrimaryState(this.Du.syncEngine, e2), this.gcScheduler && (e2 && !this.gcScheduler.started ? this.gcScheduler.start() : e2 || this.gcScheduler.stop()), this.indexBackfillerScheduler && (e2 && !this.indexBackfillerScheduler.started ? this.indexBackfillerScheduler.start() : e2 || this.indexBackfillerScheduler.stop());
    });
  }
  pu(e) {
...
var OnlineComponentProvider = class {
  ...
  async terminate() {
    ...
    await async function __PRIVATE_remoteStoreShutdown(e2) {
      ...
      __PRIVATE_logDebug(Xt, "RemoteStore shutting down."), t2.Ta.add(
        5
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    this.Fu = e, this.serializer = t, /** Cached bundle metadata. */
    ...
    this.xu().then((e2) => {
      e2 && e2.qa() ? this.metadata.resolve(e2.ka.metadata) : this.metadata.reject(new Error(`The first element of the bundle is not a metadata, it is
             ${JSON.stringify(null == e2 ? void 0 : e2.ka)}`));
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r, this.deferred = i, this.Qu = n.maxAttempts, this.C_ = new __PRIVATE_ExponentialBackoff(
      this.asyncQueue,
      "transaction_retry"
  ...
  Wu(e) {
    this.Qu > 0 && this.Gu(e) ? (this.Qu -= 1, this.asyncQueue.enqueueAndForget(() => (this.Uu(), Promise.resolve()))) : this.deferred.reject(e);
  }
  Gu(e) {
...
function __PRIVATE_firestoreClientGetDocumentViaSnapshotListener(e, t, n = {}) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_readDocumentViaSnapshotListener(e2, t2, n2, r2, i) {
    const s = new __PRIVATE_AsyncObserver({
      next: (_) => {
        s.Cu(), t2.enqueueAndForget(() => __PRIVATE_eventManagerUnlisten(e2, o));
  ...
  return e.asyncQueue.enqueueAndForget(async () => async function __PRIVATE_executeQueryFromCache(e2, t2, n2) {
    try {
      const r = await __PRIVATE_localStoreExecuteQuery(
        ...
        /* usePreviousResults= */
        true
      ), i = new __PRIVATE_View(t2, r.$s), s = i.Za(r.documents), o = i.applyChanges(
        s,
        /* limboResolutionEnabled= */
        false
      );
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    __PRIVATE_debugCast(e2).ba.add(t2), // Immediately fire an initial event, indicating all existing listeners
    // are in-sync.
    t2.next();
  }(await __PRIVATE_getEventManager(e), n)), () => {
    n.Cu(), e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_removeSnapshotsInSyncListener(e2, t2) {
      __PRIVATE_debugCast(e2).ba.delete(t2);
    }(await __PRIVATE_getEventManager(e), n));
  };
}
...
function connectFirestoreEmulator(e, t, n, r = {}) {
  ...
  if (!deepEqual(u, _) && (e._setSettings(u), s && (pingServer(`https://${a}`), updateEmulatorBanner("Firestore", true)), r.mockUserToken)) {
    let t2, n2;
...
var __PRIVATE_AsyncQueueImpl = class {
  constructor(e = Promise.resolve()) {
    ...
    // be changed again.
    this.ju = false, // Operations scheduled to be queued in the future. Operations are
    // automatically removed after they are run or canceled.
    this.Hu = [], // visible for testing
    this.Ju = null, // Flag set while there's an outstanding AsyncQueue operation, used for
    // assertion sanity-checks.
    this.Yu = false, // Enabled during shutdown on Safari to prevent future access to IndexedDB.
    this.Zu = false, // List of TimerIds to fast-forward delays for.
    this.Xu = [], // Backoff timer used to schedule retries for retryable operations
    this.C_ = new __PRIVATE_ExponentialBackoff(
      this,
      "async_queue_retry"
    ...
    this.ec = () => {
      ...
      e2 && __PRIVATE_logDebug(an, "Visibility state changed to " + e2.visibilityState), this.C_.p_();
    }, this.tc = e;
    const t = getDocument();
  ...
  enqueueAndForgetEvenWhileRestricted(e) {
    this.nc(), // eslint-disable-next-line @typescript-eslint/no-floating-promises
    this.rc(e);
  }
  enterRestrictedMode(e) {
    if (!this.ju) {
      this.ju = true, this.Zu = e || false;
      const t = getDocument();
  ...
  enqueue(e) {
    ...
    return this.rc(() => this.ju && this.Zu ? Promise.resolve() : (e().then(t.resolve, t.reject), t.promise)).then(() => t.promise);
  }
  enqueueRetryable(e) {
  ...
  rc(e) {
    const t = this.tc.then(() => (this.Yu = true, e().catch((e2) => {
      this.Ju = e2, this.Yu = false;
      throw __PRIVATE_logError("INTERNAL UNHANDLED ERROR: ", __PRIVATE_getMessageOrStack(e2)), e2;
    }).then((e2) => (this.Yu = false, e2))));
    return this.tc = t, t;
  }
  enqueueAfterDelay(e, t, n) {
    this.nc(), // Fast-forward delays for timerIds that have been overridden.
    this.Xu.indexOf(e) > -1 && (t = 0);
    const r = DelayedOperation.createAndSchedule(this, e, t, n, (e2) => this.oc(e2));
   ...
   */
  uc(e) {
    for (const t of this.Hu) if (t.timerId === e) return true;
    return false;
  }
  /**
  ...
  cc(e) {
    return this.ac().then(() => {
      this.Hu.sort((e2, t) => e2.targetTimeMs - t.targetTimeMs);
      for (const t of this.Hu) if (t.skipDelay(), "all" !== e && t.timerId === e) break;
      return this.ac();
    });
  }
  /**
...
var __PRIVATE_ParseContextImpl = class ___PRIVATE_ParseContextImpl {
  ...
  Vc(e) {
    return __PRIVATE_createError(e, this.settings.methodName, this.settings.mc || false, this.path, this.settings.fc);
  }
...
function __PRIVATE_parseSetData(e, t, n, r, i, s = {}) {
  const o = e.gc(s.merge || s.mergeFields ? 2 : 0, t, n, i);
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.hc) throw 1 === e.hc ? e.Vc(`${this._methodName}() can only appear at the top level of your update data`) : e.Vc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
var __PRIVATE_ArrayUnionFieldValueImpl = class ___PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.yc.map((e2) => __PRIVATE_parseData(e2, t)), r = new __PRIVATE_ArrayUnionTransformOperation(n);
    return new FieldTransform(e.path, r);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_ArrayUnionFieldValueImpl && deepEqual(this.yc, e.yc);
  }
};
var __PRIVATE_ArrayRemoveFieldValueImpl = class ___PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), n = this.yc.map((e2) => __PRIVATE_parseData(e2, t)), r = new __PRIVATE_ArrayRemoveTransformOperation(n);
    return new FieldTransform(e.path, r);
  }
  isEqual(e) {
    return e instanceof ___PRIVATE_ArrayRemoveFieldValueImpl && deepEqual(this.yc, e.yc);
  }
};
var __PRIVATE_NumericIncrementFieldValueImpl = class ___PRIVATE_NumericIncrementFieldValueImpl extends FieldValue {
  ...
  isEqual(e) {
    return e instanceof ___PRIVATE_NumericIncrementFieldValueImpl && this.wc === e.wc;
  }
};
...
function __PRIVATE_parseUpdateVarargs(e, t, n, r, i, s) {
  const o = e.gc(1, t, n), _ = [__PRIVATE_fieldPathFromArgument$1(t, r, n)], a = [i];
...
function __PRIVATE_parseQueryValue(e, t, n, r = false) {
  return __PRIVATE_parseData(n, e.gc(r ? 4 : 3, t));
}
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.hc)) throw t2.Vc(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path) throw t2.Vc(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  if (
    ...
    if (t.settings.Ec && 4 !== t.hc) throw t.Vc("Nested arrays are not supported");
    return function __PRIVATE_parseArray(e2, t2) {
      const n = [];
      let r = 0;
      for (const i of e2) {
        let e3 = __PRIVATE_parseData(i, t2.Rc(r));
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r.isEqual(n)) throw t2.Vc(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);
      return {
            ...
            [Tt]: {
              arrayValue: {
                values: e3.toArray().map((e4) => {
                  if ("number" != typeof e4) throw t3.Vc("VectorValues must only contain numeric values.");
    ...
    throw t2.Vc(`Unsupported field value: ${__PRIVATE_valueDescription(e2)}`);
  }(e, t);
}
function __PRIVATE_parseObject(e, t) {
  ...
  return isEmpty(e) ? (
    ...
    const i = __PRIVATE_parseData(r, t.Ic(e2));
    null != i && (n[e2] = i);
  }), {
    mapValue: {
      fields: n
...
function onSnapshot(e, ...t) {
  ...
  return function __PRIVATE_firestoreClientListen(e2, t2, n2, r2) {
    ...
    return e2.asyncQueue.enqueueAndForget(async () => __PRIVATE_eventManagerListen(await __PRIVATE_getEventManager(e2), s2)), () => {
      i2.Cu(), e2.asyncQueue.enqueueAndForget(async () => __PRIVATE_eventManagerUnlisten(await __PRIVATE_getEventManager(e2), s2));
    };
...
function runTransaction(e, t, n) {
  ...
  return function __PRIVATE_firestoreClientTransaction(e2, t2, n2) {
    ...
    return e2.asyncQueue.enqueueAndForget(async () => {
      ...
      new __PRIVATE_TransactionRunner(e2.asyncQueue, i, n2, t2, r2).$u();
    }), r2.promise;
