...
const CriteriaDetail = () => {
    ...
    if (!criteria) {
        return <div className="w-full h-screen flex items-center justify-center">Criteria not found</div>;
    }
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div
                ...
                style={{
                    backgroundImage: `url(${getImageUrl(criteria.image)})`
                }}
            >
                <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                    <div className="text-center text-white">
                        <h1 className="text-4xl md:text-6xl font-bold mb-4">{criteria.title}</h1>
                        <p className="text-xl md:text-2xl">{criteria.description}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto py-12 px-4">
                <div className="bg-white rounded-lg shadow-lg p-8">
                    {/* Criteria Info */}
                    <div className="mb-8">
                        <h2 className="text-3xl font-bold mb-4">{criteria.title}</h2>
                    ...
                    <div className="prose prose-lg max-w-none">
                        <div 
                            ...
                            dangerouslySetInnerHTML={{ __html: criteria.content }} 
                            style={{
