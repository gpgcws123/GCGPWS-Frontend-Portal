  ...
  useEffect(() => {
    const fetchPolicies = async () => {
      try {
        ...
        console.error('Error fetching admission policies:', error);
        setPoliciesData([]);
        setLoading(false);
      }
    };
    ...
    <div>
      ...
      <div className="my-8 p-4 bg-white">
        <div className="my-8 text-center">
          <HeadingTitle title="Admission Policies" width="640px" />
        </div>
        <HeadingWithButton headingText="Important Guidelines" buttonText="" />
          ...
          {policiesData.map((policy) => (
            ...
            >
              ...
              <div className="flex justify-center">
                <Link to={`/admission/policy/${policy._id}`}>
                  <Button
